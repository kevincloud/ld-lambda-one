...
def inc_number():
    ...
    ddb_table.update_item(
        ...
        ExpressionAttributeValues={":g": num},
...
def inc_alpha():
    ...
    ddb_table.update_item(
        ...
        ExpressionAttributeValues={":g": nextc},
        ReturnValues="UPDATED_NEW",
    )
...
def get_dbvalues():
    ...
    return json.dumps({"number": int(rec["NumberItem"]), "letter": rec["AlphaItem"]})
...
def lambda_handler(event, context):
    ...
    return {"isBase64Encoded": False, "statusCode": 200, "body": get_dbvalues()}
